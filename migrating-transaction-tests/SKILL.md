---
name: migrating-transaction-tests
description: 'Use when migrating integration tests from truncation, global database state, isolation leaks, or slow setup toward transaction-scoped fixtures.'
metadata:
...
# Migrating Transaction Tests

Use this skill when migrating integration tests from truncation, global database state, isolation leaks, or slow setup toward transaction-scoped fixtures.
