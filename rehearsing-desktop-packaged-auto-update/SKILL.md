...
description: 'Use when rehearsing desktop auto-update locally with packaged artifacts, update feeds, installer metadata, or updater logs.'
metadata:
...
# Rehearsing Desktop Packaged Auto Update

Use this skill when rehearsing desktop auto-update locally with packaged artifacts, update feeds, installer metadata, or updater logs.
