---
name: using-claude-cli-agent
description: 'Use when invoking Claude Code CLI as an external coding agent for review, debugging, implementation checks, or investigation.'
metadata:
...
# Using Claude Cli Agent

Use this skill when invoking Claude Code CLI as an external coding agent for review, debugging, implementation checks, or investigation.
