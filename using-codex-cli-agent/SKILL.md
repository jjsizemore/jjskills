---
name: using-codex-cli-agent
description: 'Use when invoking OpenAI Codex CLI as an external coding agent for review, debugging, implementation checks, or investigation.'
metadata:
...
Use this skill when invoking OpenAI Codex CLI as an external coding agent for review, debugging, implementation checks, or investigation.
