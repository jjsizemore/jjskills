...
- **Architectural Decision Records (ADRs)**: If the work involved architectural choices and trade-offs, confirm an ADR is documented in `docs/architecture/adr/` capturing: (1) decision, (2) alternatives considered, (3) tradeoffs, and (4) rationale.
