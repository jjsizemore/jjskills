---
name: triaging-stabilization
description: 'Use when assessing application stability, ranking branches or PRs, diagnosing merge readiness, or deciding what to fix or merge next.'
metadata:
...
# Triaging Stabilization

Use this skill when assessing application stability, ranking branches or PRs, diagnosing merge readiness, or deciding what to fix or merge next.
