---
name: using-antigravity-agy-cli
description: 'Use when invoking Google Antigravity agy CLI as an external coding agent for review, debugging, implementation checks, or investigation.'
metadata:
...
# Using Antigravity Agy Cli

Use this skill when invoking Google Antigravity agy CLI as an external coding agent for review, debugging, implementation checks, or investigation.
