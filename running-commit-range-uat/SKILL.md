---
name: running-commit-range-uat
description: 'Use when running repeatable user acceptance checks across each commit in a range to identify regressions or validate a stacked branch.'
metadata:
...
# Running Commit Range Uat

Use this skill when running repeatable user acceptance checks across each commit in a range to identify regressions or validate a stacked branch.
